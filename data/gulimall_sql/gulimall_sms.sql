...
CREATE TABLE `sms_member_price`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 25 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '商品会员价格' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of sms_member_price
-- ----------------------------
INSERT INTO `sms_member_price` VALUES (1, 1, 2, '铜牌会员', 5789.0000, 1);
INSERT INTO `sms_member_price` VALUES (2, 2, 2, '铜牌会员', 6789.0000, 1);
INSERT INTO `sms_member_price` VALUES (3, 3, 2, '铜牌会员', 5789.0000, 1);
INSERT INTO `sms_member_price` VALUES (4, 4, 2, '铜牌会员', 6789.0000, 1);
INSERT INTO `sms_member_price` VALUES (21, 19, 2, '铜牌会员', 6789.0000, 1);
INSERT INTO `sms_member_price` VALUES (22, 20, 2, '铜牌会员', 7789.0000, 1);
INSERT INTO `sms_member_price` VALUES (23, 21, 2, '铜牌会员', 6789.0000, 1);
INSERT INTO `sms_member_price` VALUES (24, 22, 2, '铜牌会员', 7789.0000, 1);
...
CREATE TABLE `sms_sku_full_reduction`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '商品满减信息' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of sms_sku_full_reduction
-- ----------------------------
INSERT INTO `sms_sku_full_reduction` VALUES (1, 1, 6000.0000, 100.0000, NULL);
INSERT INTO `sms_sku_full_reduction` VALUES (2, 2, 6000.0000, 100.0000, NULL);
INSERT INTO `sms_sku_full_reduction` VALUES (3, 3, 6000.0000, 100.0000, NULL);
INSERT INTO `sms_sku_full_reduction` VALUES (4, 4, 6000.0000, 100.0000, NULL);
...
CREATE TABLE `sms_sku_ladder`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 25 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '商品阶梯价格' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of sms_sku_ladder
-- ----------------------------
INSERT INTO `sms_sku_ladder` VALUES (1, 1, 3, 0.90, 5400.0000, 1);
INSERT INTO `sms_sku_ladder` VALUES (2, 2, 3, 0.90, 5400.0000, 1);
INSERT INTO `sms_sku_ladder` VALUES (3, 3, 3, 0.90, 5400.0000, 1);
INSERT INTO `sms_sku_ladder` VALUES (4, 4, 3, 0.90, 5400.0000, 1);
INSERT INTO `sms_sku_ladder` VALUES (21, 19, 3, 0.90, 6119.1000, 1);
INSERT INTO `sms_sku_ladder` VALUES (22, 20, 3, 0.90, 7019.1000, 0);
INSERT INTO `sms_sku_ladder` VALUES (23, 21, 3, 0.90, 6119.1000, 0);
INSERT INTO `sms_sku_ladder` VALUES (24, 22, 3, 0.90, 7019.1000, 1);
...
CREATE TABLE `sms_spu_bounds`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '商品spu积分设置' ROW_FORMAT = Compact;
