...
) ENGINE = InnoDB AUTO_INCREMENT = 13 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '商品属性' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of pms_attr
-- ----------------------------
INSERT INTO `pms_attr` VALUES (2, '入网型号', 1, 'xxxx', 'A2233', 1, 1, 225, 1);
INSERT INTO `pms_attr` VALUES (3, '上市年份', 0, 'xxxx', '2019;2020', 1, 1, 225, 1);
INSERT INTO `pms_attr` VALUES (4, '品牌', 1, 'xxxx', '苹果;华为', 1, 1, 225, 1);
INSERT INTO `pms_attr` VALUES (6, '颜色', 0, 'xxxxx', '白色;黑色;金色', 0, 1, 225, 0);
INSERT INTO `pms_attr` VALUES (7, '内存', 0, 'xxxx', '16G;32G', 0, 1, 225, 0);
INSERT INTO `pms_attr` VALUES (8, '机身重量', 0, 'xxxxx', '100g', 1, 1, 225, 1);
INSERT INTO `pms_attr` VALUES (9, '机身宽度', 0, 'xxxx', '75.6', 1, 1, 225, 0);
INSERT INTO `pms_attr` VALUES (11, '手机名称', 1, 'xxxxx', 'iphone11', 1, 1, 225, 1);
INSERT INTO `pms_attr` VALUES (12, 'GPU型号', 1, 'xxxxx', '以官网信息为准', 1, 1, 225, 1);
...
) ENGINE = InnoDB AUTO_INCREMENT = 31 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '属性&属性分组关联' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of pms_attr_attrgroup_relation
-- ----------------------------
INSERT INTO `pms_attr_attrgroup_relation` VALUES (1, 2, 5, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (22, 4, 4, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (25, 8, 5, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (26, 9, 5, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (28, 11, 4, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (29, 3, 4, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (30, 12, 6, NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '属性分组' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of pms_attr_group
-- ----------------------------
INSERT INTO `pms_attr_group` VALUES (4, '主体', 1, 'xxxx', 'xxxx', 225);
INSERT INTO `pms_attr_group` VALUES (5, '基本信息', 2, 'xxxxx', 'xxxxx', 225);
INSERT INTO `pms_attr_group` VALUES (6, '主芯片', 0, 'xxxx', 'xxxxx', 225);
...
-- ----------------------------
INSERT INTO `pms_brand` VALUES (1, '华为', 'https://gar-gulimall.oss-cn-guangzhou.aliyuncs.com/20230825/09a51229-819e-4b58-8c06-bac4deaf9a77_huawei.png', 'xxxx', 1, 'H', 1);
INSERT INTO `pms_brand` VALUES (2, '小米', 'https://gar-gulimall.oss-cn-guangzhou.aliyuncs.com/20230825/4fe63211-0789-4c94-8a83-7d292836d70b_xiaomi.png', 'xxx', 1, 'X', 1);
INSERT INTO `pms_brand` VALUES (3, 'oppo', 'https://gar-gulimall.oss-cn-guangzhou.aliyuncs.com/20230825/36b1b357-c775-4380-849a-2f4984eb7c97_oppo.png', 'xxxx', 1, 'O', 1);
INSERT INTO `pms_brand` VALUES (4, '苹果', 'https://gar-gulimall.oss-cn-guangzhou.aliyuncs.com/20230830/b51524ae-3a34-4019-865a-bad8113281ac_apple.png', 'xxxxx', 1, 'A', 1);
...
) ENGINE = InnoDB AUTO_INCREMENT = 1443 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '商品三级分类' ROW_FORMAT = Compact;
...
INSERT INTO `pms_category` VALUES (33, '其他', 1, 2, 1, 0, 'dmeo', 'demo', 0);
...
INSERT INTO `pms_category` VALUES (1442, '其他2', 1, 2, 0, 0, '', '', NULL);
...
CREATE TABLE `pms_category_brand_relation`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '品牌分类关联' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of pms_category_brand_relation
-- ----------------------------
INSERT INTO `pms_category_brand_relation` VALUES (3, 1, 225, '华为', '手机');
INSERT INTO `pms_category_brand_relation` VALUES (4, 1, 227, '华为', '合约机');
INSERT INTO `pms_category_brand_relation` VALUES (5, 2, 225, '小米', '手机');
INSERT INTO `pms_category_brand_relation` VALUES (6, 3, 225, 'oppo', '手机');
INSERT INTO `pms_category_brand_relation` VALUES (7, 4, 225, '苹果', '手机');
...
CREATE TABLE `pms_product_attr_value`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 50 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'spu属性值' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of pms_product_attr_value
-- ----------------------------
INSERT INTO `pms_product_attr_value` VALUES (1, 1, 3, '上市年份', '2019', NULL, NULL);
INSERT INTO `pms_product_attr_value` VALUES (2, 1, 4, '品牌', '华为', NULL, NULL);
INSERT INTO `pms_product_attr_value` VALUES (3, 1, 11, '手机名称', 'HUAWEI MATE 60 PLUS', NULL, NULL);
INSERT INTO `pms_product_attr_value` VALUES (4, 1, 2, '入网型号', 'A2233', NULL, NULL);
INSERT INTO `pms_product_attr_value` VALUES (5, 1, 8, '机身重量', '100g', NULL, NULL);
INSERT INTO `pms_product_attr_value` VALUES (6, 1, 9, '机身宽度', '75.6', NULL, NULL);
INSERT INTO `pms_product_attr_value` VALUES (7, 1, 12, 'GPU型号', '以官网信息为准', NULL, NULL);
INSERT INTO `pms_product_attr_value` VALUES (43, 7, 3, '上市年份', '2020', NULL, NULL);
INSERT INTO `pms_product_attr_value` VALUES (44, 7, 4, '品牌', '苹果', NULL, NULL);
INSERT INTO `pms_product_attr_value` VALUES (45, 7, 11, '手机名称', 'iphone xr', NULL, NULL);
INSERT INTO `pms_product_attr_value` VALUES (46, 7, 2, '入网型号', 'A2233', NULL, NULL);
INSERT INTO `pms_product_attr_value` VALUES (47, 7, 8, '机身重量', '100g', NULL, NULL);
INSERT INTO `pms_product_attr_value` VALUES (48, 7, 9, '机身宽度', '75.6', NULL, NULL);
INSERT INTO `pms_product_attr_value` VALUES (49, 7, 12, 'GPU型号', '以官网信息为准', NULL, NULL);
...
CREATE TABLE `pms_sku_images`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 72 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'sku图片' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of pms_sku_images
-- ----------------------------
INSERT INTO `pms_sku_images` VALUES (1, 1, 'https://gar-gulimall.oss-cn-guangzhou.aliyuncs.com/20230829/3f215a4f-b7bb-4089-814d-fa68f1794941_0d40c24b264aa511.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (2, 1, 'https://gar-gulimall.oss-cn-guangzhou.aliyuncs.com/20230829/08f8beab-82a7-4201-8e18-e61607c25eb7_2b1837c6c50add30.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (3, 1, '', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (4, 1, 'https://gar-gulimall.oss-cn-guangzhou.aliyuncs.com/20230829/4bc3f59e-f8ce-47a8-8439-dd2e704c50c8_335b2c690e43a8f8.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (5, 1, '', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (6, 2, 'https://gar-gulimall.oss-cn-guangzhou.aliyuncs.com/20230829/3f215a4f-b7bb-4089-814d-fa68f1794941_0d40c24b264aa511.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (7, 2, '', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (8, 2, 'https://gar-gulimall.oss-cn-guangzhou.aliyuncs.com/20230829/9c3d101a-111c-46c3-8295-c02ae5752b9d_3c24f9cd69534030.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (9, 2, '', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (10, 2, 'https://gar-gulimall.oss-cn-guangzhou.aliyuncs.com/20230829/272397e2-f6e1-4c0b-8008-5a4f83a82033_23d9fbb256ea5d4a.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (11, 3, 'https://gar-gulimall.oss-cn-guangzhou.aliyuncs.com/20230829/3f215a4f-b7bb-4089-814d-fa68f1794941_0d40c24b264aa511.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (12, 3, 'https://gar-gulimall.oss-cn-guangzhou.aliyuncs.com/20230829/08f8beab-82a7-4201-8e18-e61607c25eb7_2b1837c6c50add30.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (13, 3, '', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (14, 3, 'https://gar-gulimall.oss-cn-guangzhou.aliyuncs.com/20230829/4bc3f59e-f8ce-47a8-8439-dd2e704c50c8_335b2c690e43a8f8.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (15, 3, '', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (16, 4, 'https://gar-gulimall.oss-cn-guangzhou.aliyuncs.com/20230829/3f215a4f-b7bb-4089-814d-fa68f1794941_0d40c24b264aa511.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (17, 4, '', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (18, 4, 'https://gar-gulimall.oss-cn-guangzhou.aliyuncs.com/20230829/9c3d101a-111c-46c3-8295-c02ae5752b9d_3c24f9cd69534030.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (19, 4, '', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (20, 4, 'https://gar-gulimall.oss-cn-guangzhou.aliyuncs.com/20230829/272397e2-f6e1-4c0b-8008-5a4f83a82033_23d9fbb256ea5d4a.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (60, 19, 'https://gar-gulimall.oss-cn-guangzhou.aliyuncs.com/20230830/5c0fe3ed-e14b-4a06-8aa3-a6ef19c9c9c5_7ae0120ec27dc3a7.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (61, 19, 'https://gar-gulimall.oss-cn-guangzhou.aliyuncs.com/20230830/1979ee15-034d-426f-8aa7-c4e568691bc8_23cd65077f12f7f5.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (62, 19, 'https://gar-gulimall.oss-cn-guangzhou.aliyuncs.com/20230830/95c403eb-ed12-419f-8a3f-f03d1d351fa3_749d8efdff062fb0.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (63, 20, 'https://gar-gulimall.oss-cn-guangzhou.aliyuncs.com/20230830/5c0fe3ed-e14b-4a06-8aa3-a6ef19c9c9c5_7ae0120ec27dc3a7.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (64, 20, 'https://gar-gulimall.oss-cn-guangzhou.aliyuncs.com/20230830/1979ee15-034d-426f-8aa7-c4e568691bc8_23cd65077f12f7f5.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (65, 20, 'https://gar-gulimall.oss-cn-guangzhou.aliyuncs.com/20230830/95c403eb-ed12-419f-8a3f-f03d1d351fa3_749d8efdff062fb0.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (66, 21, 'https://gar-gulimall.oss-cn-guangzhou.aliyuncs.com/20230830/5c0fe3ed-e14b-4a06-8aa3-a6ef19c9c9c5_7ae0120ec27dc3a7.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (67, 21, 'https://gar-gulimall.oss-cn-guangzhou.aliyuncs.com/20230830/6977aa50-2612-4ed5-8e52-73d667701de7_5b5e74d0978360a1.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (68, 21, 'https://gar-gulimall.oss-cn-guangzhou.aliyuncs.com/20230830/1e83d7d2-b3ad-4094-8203-c9f35e383619_6a1b2703a9ed8737.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (69, 22, 'https://gar-gulimall.oss-cn-guangzhou.aliyuncs.com/20230830/5c0fe3ed-e14b-4a06-8aa3-a6ef19c9c9c5_7ae0120ec27dc3a7.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (70, 22, 'https://gar-gulimall.oss-cn-guangzhou.aliyuncs.com/20230830/6977aa50-2612-4ed5-8e52-73d667701de7_5b5e74d0978360a1.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (71, 22, 'https://gar-gulimall.oss-cn-guangzhou.aliyuncs.com/20230830/1e83d7d2-b3ad-4094-8203-c9f35e383619_6a1b2703a9ed8737.jpg', NULL, 0);
...
) ENGINE = InnoDB AUTO_INCREMENT = 23 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'sku信息' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of pms_sku_info
-- ----------------------------
INSERT INTO `pms_sku_info` VALUES (1, 1, 'HUAWEI MATE 60 PLUS 亮黑色 16G+128G', NULL, 225, 1, 'https://gar-gulimall.oss-cn-guangzhou.aliyuncs.com/20230829/3f215a4f-b7bb-4089-814d-fa68f1794941_0d40c24b264aa511.jpg', 'HUAWEI MATE 60 PLUS 亮黑色 16G+128G', ' 曲面旗舰 超光变XMAGE影像 北斗卫星消息', 6000.0000, 0);
INSERT INTO `pms_sku_info` VALUES (2, 1, 'HUAWEI MATE 60 PLUS 亮黑色 16G+256G', NULL, 225, 1, 'https://gar-gulimall.oss-cn-guangzhou.aliyuncs.com/20230829/3f215a4f-b7bb-4089-814d-fa68f1794941_0d40c24b264aa511.jpg', 'HUAWEI MATE 60 PLUS 亮黑色 16G+256G', ' 曲面旗舰 超光变XMAGE影像 北斗卫星消息', 6000.0000, 0);
INSERT INTO `pms_sku_info` VALUES (3, 1, 'HUAWEI MATE 60 PLUS 墨绿色 16G+128G', NULL, 225, 1, 'https://gar-gulimall.oss-cn-guangzhou.aliyuncs.com/20230829/3f215a4f-b7bb-4089-814d-fa68f1794941_0d40c24b264aa511.jpg', 'HUAWEI MATE 60 PLUS 墨绿色 16G+128G', ' 曲面旗舰 超光变XMAGE影像 北斗卫星消息', 6000.0000, 0);
INSERT INTO `pms_sku_info` VALUES (4, 1, 'HUAWEI MATE 60 PLUS 墨绿色 16G+256G', NULL, 225, 1, 'https://gar-gulimall.oss-cn-guangzhou.aliyuncs.com/20230829/3f215a4f-b7bb-4089-814d-fa68f1794941_0d40c24b264aa511.jpg', 'HUAWEI MATE 60 PLUS 墨绿色 16G+256G', ' 曲面旗舰 超光变XMAGE影像 北斗卫星消息', 6000.0000, 0);
INSERT INTO `pms_sku_info` VALUES (19, 7, 'IPHONE XR 白色 16G', NULL, 225, 4, 'https://gar-gulimall.oss-cn-guangzhou.aliyuncs.com/20230830/5c0fe3ed-e14b-4a06-8aa3-a6ef19c9c9c5_7ae0120ec27dc3a7.jpg', 'IPHONE XR 白色 16G', '支持移动联通电信5G 双卡双待手机', 6799.0000, 0);
INSERT INTO `pms_sku_info` VALUES (20, 7, 'IPHONE XR 白色 32G', NULL, 225, 4, 'https://gar-gulimall.oss-cn-guangzhou.aliyuncs.com/20230830/5c0fe3ed-e14b-4a06-8aa3-a6ef19c9c9c5_7ae0120ec27dc3a7.jpg', 'IPHONE XR 白色 32G', '支持移动联通电信5G 双卡双待手机', 7799.0000, 0);
INSERT INTO `pms_sku_info` VALUES (21, 7, 'IPHONE XR 红色 16G', NULL, 225, 4, 'https://gar-gulimall.oss-cn-guangzhou.aliyuncs.com/20230830/5c0fe3ed-e14b-4a06-8aa3-a6ef19c9c9c5_7ae0120ec27dc3a7.jpg', 'IPHONE XR 红色 16G', '支持移动联通电信5G 双卡双待手机', 6799.0000, 0);
INSERT INTO `pms_sku_info` VALUES (22, 7, 'IPHONE XR 红色 32G', NULL, 225, 4, 'https://gar-gulimall.oss-cn-guangzhou.aliyuncs.com/20230830/5c0fe3ed-e14b-4a06-8aa3-a6ef19c9c9c5_7ae0120ec27dc3a7.jpg', 'IPHONE XR 红色 32G', '支持移动联通电信5G 双卡双待手机', 7799.0000, 0);
...
CREATE TABLE `pms_sku_sale_attr_value`  (
  ...
  `attr_sort` int(11) NULL DEFAULT NULL COMMENT '顺序',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 45 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'sku销售属性&值' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of pms_sku_sale_attr_value
-- ----------------------------
INSERT INTO `pms_sku_sale_attr_value` VALUES (1, 1, 6, '颜色', '亮黑色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (2, 1, 7, '内存', '16G+128G', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (3, 2, 6, '颜色', '亮黑色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (4, 2, 7, '内存', '16G+256G', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (5, 3, 6, '颜色', '墨绿色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (6, 3, 7, '内存', '16G+128G', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (7, 4, 6, '颜色', '墨绿色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (8, 4, 7, '内存', '16G+256G', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (37, 19, 6, '颜色', '白色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (38, 19, 7, '内存', '16G', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (39, 20, 6, '颜色', '白色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (40, 20, 7, '内存', '32G', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (41, 21, 6, '颜色', '红色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (42, 21, 7, '内存', '16G', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (43, 22, 6, '颜色', '红色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (44, 22, 7, '内存', '32G', NULL);
...
CREATE TABLE `pms_spu_images`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 36 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'spu图片' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of pms_spu_images
-- ----------------------------
INSERT INTO `pms_spu_images` VALUES (1, 1, NULL, 'https://gar-gulimall.oss-cn-guangzhou.aliyuncs.com/20230829/3f215a4f-b7bb-4089-814d-fa68f1794941_0d40c24b264aa511.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (2, 1, NULL, 'https://gar-gulimall.oss-cn-guangzhou.aliyuncs.com/20230829/08f8beab-82a7-4201-8e18-e61607c25eb7_2b1837c6c50add30.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (3, 1, NULL, 'https://gar-gulimall.oss-cn-guangzhou.aliyuncs.com/20230829/9c3d101a-111c-46c3-8295-c02ae5752b9d_3c24f9cd69534030.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (4, 1, NULL, 'https://gar-gulimall.oss-cn-guangzhou.aliyuncs.com/20230829/4bc3f59e-f8ce-47a8-8439-dd2e704c50c8_335b2c690e43a8f8.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (5, 1, NULL, 'https://gar-gulimall.oss-cn-guangzhou.aliyuncs.com/20230829/272397e2-f6e1-4c0b-8008-5a4f83a82033_23d9fbb256ea5d4a.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (31, 7, NULL, 'https://gar-gulimall.oss-cn-guangzhou.aliyuncs.com/20230830/5c0fe3ed-e14b-4a06-8aa3-a6ef19c9c9c5_7ae0120ec27dc3a7.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (32, 7, NULL, 'https://gar-gulimall.oss-cn-guangzhou.aliyuncs.com/20230830/6977aa50-2612-4ed5-8e52-73d667701de7_5b5e74d0978360a1.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (33, 7, NULL, 'https://gar-gulimall.oss-cn-guangzhou.aliyuncs.com/20230830/1979ee15-034d-426f-8aa7-c4e568691bc8_23cd65077f12f7f5.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (34, 7, NULL, 'https://gar-gulimall.oss-cn-guangzhou.aliyuncs.com/20230830/1e83d7d2-b3ad-4094-8203-c9f35e383619_6a1b2703a9ed8737.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (35, 7, NULL, 'https://gar-gulimall.oss-cn-guangzhou.aliyuncs.com/20230830/95c403eb-ed12-419f-8a3f-f03d1d351fa3_749d8efdff062fb0.jpg', NULL, NULL);
...
CREATE TABLE `pms_spu_info`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'spu信息' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of pms_spu_info
-- ----------------------------
INSERT INTO `pms_spu_info` VALUES (1, 'HUAWEI MATE 60 PLUS', 'HUAWEI MATE 60 PLUS', 225, 1, 1.0000, 1, '2023-09-08 16:10:12', '2023-08-29 17:29:37');
INSERT INTO `pms_spu_info` VALUES (7, 'IPHONE XR', 'IPHONE XR', 225, 4, 100.0000, 1, '2023-09-08 16:10:22', '2023-08-30 14:25:56');
...
-- ----------------------------
INSERT INTO `pms_spu_info_desc` VALUES (1, 'https://gar-gulimall.oss-cn-guangzhou.aliyuncs.com/20230829/7c24c54d-2844-4af2-8d84-009f6cdb038d_73366cc235d68202.jpg,https://gar-gulimall.oss-cn-guangzhou.aliyuncs.com/20230829/dbf2ff25-de3e-4476-860c-2eda2f73a0bf_528211b97272d88a.jpg');
INSERT INTO `pms_spu_info_desc` VALUES (7, 'https://gar-gulimall.oss-cn-guangzhou.aliyuncs.com/20230830/e86376fe-20b5-475d-8951-ea9c520cfa3e_f205d9c99a2b4b01.jpg');
