...
CREATE TABLE `wms_purchase`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '采购信息' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of wms_purchase
-- ----------------------------
INSERT INTO `wms_purchase` VALUES (1, 1, 'admin', '13612345678', 1, 1, NULL, NULL, NULL, NULL);
INSERT INTO `wms_purchase` VALUES (2, 1, 'admin', '13612345678', NULL, 1, NULL, NULL, '2023-08-31 16:01:31', '2023-08-31 16:01:31');
...
-- ----------------------------
INSERT INTO `wms_purchase_detail` VALUES (1, 1, 1, 10, NULL, 1, 0);
INSERT INTO `wms_purchase_detail` VALUES (2, 1, 1, 10, NULL, 1, 0);
INSERT INTO `wms_purchase_detail` VALUES (3, 2, 1, 100, NULL, 1, 0);
...
-- ----------------------------
INSERT INTO `wms_ware_info` VALUES (1, '1号仓库', '广州', '510530');
INSERT INTO `wms_ware_info` VALUES (2, '2号仓库', '深圳', '123456');
...
CREATE TABLE `wms_ware_order_task`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '库存工作单' ROW_FORMAT = Compact;
...
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '商品库存' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of wms_ware_sku
-- ----------------------------
INSERT INTO `wms_ware_sku` VALUES (1, 1, 1, 10, '苹果手机', 0);
INSERT INTO `wms_ware_sku` VALUES (2, 2, 2, 100, '华为手机', 0);
